...
Where that half is built, and why this repository stays MIT throughout, is
[Everything here is MIT, and the platform is elsewhere](everything-here-is-mit-and-the-platform-is-elsewhere.md).
