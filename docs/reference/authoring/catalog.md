...
[Data lifecycle is per field](../../concepts/architecture.md#data-lifecycle-is-per-field); what the
compiler does with the hint is on the [compile page](../publishing/compile.md#holes-what-a-data-hint-compiles-to).
...
converter beat validator-internal traversal is argued in [`api.md`](../../concepts/api.md). Duplicate
